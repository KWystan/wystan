...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen bg-white text-black">
       ...
       * Mobile: sidebar is a fixed drawer, content flows normally
       * Desktop: sticky sidebar sits left of content with a gap,
       *          whole group centered via max-width + mx-auto
       */}
      <div className="lg:flex lg:min-h-screen lg:max-w-[1280px] lg:mx-auto lg:px-4 lg:gap-3">
