                ...
                return (
                  <li key={link.label}>
                    <Link
                      to={link.href}
                      onClick={onClose}
                      className={`flex items-center gap-3 px-3 py-2 rounded-lg text-[12px] transition-all duration-150 active:scale-[0.97] ${
                        isActive
          ...
          <div className="px-6 py-4 border-t border-black/6">
            <div className="flex items-center gap-1.5">
              <a
                ...
                className="w-7 h-7 rounded-lg flex items-center justify-center text-black/30 hover-gate:text-black/65 active:scale-[0.92] transition-all duration-150"
                aria-label="GitHub"
              >
                {socialIcons.GitHub}
              </a>
              <a
                href="https://www.facebook.com/stanwy.2024/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-7 h-7 rounded-lg flex items-center justify-center text-black/30 hover-gate:text-black/65 active:scale-[0.92] transition-all duration-150"
                aria-label="Facebook"
                ...
                return (
                  <li key={link.label}>
                    <Link
                      to={link.href}
                      onClick={onClose}
                      className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-[12px] transition-all duration-150 active:scale-[0.97] ${
                        isActive
                          ? 'bg-black/[0.04] text-black font-medium'
                          : 'text-black/65 hover-gate:text-black hover-gate:bg-black/[0.02]'
                      }`}
